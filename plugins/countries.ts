...
export default defineNuxtPlugin((nuxtApp) => {
  nuxtApp.provide("getCountry", (code: string) => {
    const country = countries
      .filter((country) => country.code === code.toUpperCase())
  ...
  const countries = [
    ...
    { code: "BR", name: "Brésil" },
    { code: "IO", name: "Océan Indien Britannique" },
    ...
    { code: "KP", name: "Corée du Nord, République populaire démocratique" },
    { code: "KR", name: "Corée du Sud, République" },
    { code: "KW", name: "Koweit" },
    { code: "KG", name: "Kirghistan" },
    { code: "LA", name: "Laos" },
    ...
    { code: "SZ", name: "Ngwane, Royaume d'Eswatini" },
    { code: "SE", name: "Suède" },
    { code: "CH", name: "Suisse" },
    { code: "SY", name: "Syrie" },
    { code: "TW", name: "Taïwan" },
    { code: "TJ", name: "Tadjikistan" },
    { code: "TZ", name: "Tanzanie, République unie" },
    ...
    { code: "US", name: "États-Unis d'Amérique" },
    ...
    { code: "SS", name: "Sud-Soudan" },
    { code: "XK", name: "Kosovo" },
    { code: "ZZ", name: "Pays inconnu" },
  ];
});
