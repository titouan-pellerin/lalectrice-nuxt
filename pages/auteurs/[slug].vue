<template>
  <div v-if="author">
    ...
    <p v-if="author.nationalite">Pays : {{ $getCountry(author.nationalite) }}</p>
    <img v-if="author.photo" :src="author.photo.url" />
    <div class="author-books">
      <h2 v-if="author.traducteur">Livres traduits chroniqués :</h2>
      <h2 v-else>Livres écrits chroniqués :</h2>
    ...
    <div v-if="author.interviews.length > 0" class="author-interview">
      <h2>Interviews :</h2>
